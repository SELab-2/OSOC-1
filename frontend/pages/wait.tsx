  ...
  return (
    <div className="h-screen bg-[url('../public/img/login.png')] bg-center">
        ...
        >
          ...
          <section>
            <h2 className="text-xl font-medium">Please wait while we enable your account ...</h2>
            <p className="text-sm opacity-60">We{"'"}ll let you know once this has been completed</p>
          </section>
