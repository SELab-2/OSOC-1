...
class ProjectServiceTests {
    ...
    fun `getAllProjects does not fail`() {
        val service = ProjectService(getRepository(true), getRoleRepository())
    ...
    fun `getProjectById fails when no project with that id exists`() {
        val service = ProjectService(getRepository(false), getRoleRepository())
    ...
    fun `deleteProjectById succeeds when project with id exists`() {
        ...
        val service = ProjectService(repo, getRoleRepository())
    ...
    fun `patchProject updates project when project with same id exists`() {
        ...
        val service = ProjectService(repository, getRoleRepository())
